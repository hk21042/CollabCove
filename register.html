...
<html>
  ...
  <center>
    <form action="register.php" method="post">
      <div width=22vw>
        <input class="input_field" type="text" name="email" placeholder="Email" value="<?php echo $email ?>" required><br><br>
        <input class="input_field" type="text" name="name" placeholder="Full Name" value="<?php echo $name ?>" required><br><br>
