  ...
  <body>
    ...
    <div class="content">
      <div class="sidenav">
        ...
        <center style="margin-top: 33vh;"></center>
        <div class="tooltip">
          ...
          <tr>
            ...
            <td style="width:50%">
              <form action="profile.php" method="post">
                Change name
                <br>
                <input class="changeText" type="text" name="changeName" placeholder="<?php echo $_SESSION['name'] ?>" value="<?php echo $_SESSION['name'] ?>" required>
                <br>
                <br> Change email
                <br>
                <input class="changeText" type="text" name="changeEmail" placeholder="<?php echo $_SESSION['email'] ?>" value="<?php echo $_SESSION['email'] ?>" required>
                <br>
                <br> Change password
                <br>
                <input class="changeText" type="password" name="changePassword" value="<?php echo $_SESSION['password'] ?>" required>
